 ...
 */
 ...
 /* <DoC-Note> 
  * Add classes tot his to enable them as starting classes?
  */

/* ONLY PUT STARTING CLASSES HERE */
int parse_class(char arg)
{
  arg = LOWER(arg);
...
int parse_all_class(char arg)
{
  ...
  case '5': return CLASS_CLASS5;
  case '6': return CLASS_CLASS5;
  case '7': return CLASS_CLASS5;
  case '8': return CLASS_CLASS5;
  case '9': return CLASS_CLASS5;
  default:  return CLASS_UNDEFINED;
  }
}
...
bitvector_t find_class_bitvector(const char *arg)
{
  ...
  for (rpos = 0; rpos < strlen(arg); rpos++)
    ret |= (1 << parse_all_class(arg[rpos]));
...
int prac_params[4][NUM_CLASSES] = {
  /* MAG  CLE	THE	  WAR   PAL   SC5   SC6   SC7   SC8   SC9*/
  { 95,	  95,	85,	  80,   90,   90,   90,   90,   90,   90	},	/* learned level */
  { 100,  100,  12,	  12,   100,  100,  100,  100,  100,  100	},	/* max per practice */
  { 25,	  25,	0,	  0,    25,   25,   25,   25,   25,   25	},	/* min per practice */
  { SPELL,SPELL,SKILL,SKILL,SPELL,SPELL,SPELL,SPELL,SPELL,SPELL	},	/* prac name */
};
...
int level_exp(int chclass, int level)
{
  ...
  switch (chclass) {
    ...
    switch (level) {
      ...
      case 31: return 8900000;
      case 32: return 9000000;
      case 33: return 10000000;
      case 34: return 11000000;
      case 35: return 12000000;
      case 36: return 13000000;
      case 37: return 14000000;
      case 38: return 15000000;
      case 39: return 16000000;
      case 40: return 20000000;
      case 41: return 40000000;
      case 42: return 41600000;
      case 43: return 45000000;
      case 44: return 47000000;
      case 45: return 49000000;
      case 46: return 51000000;
      case 47: return 55050000;
      case 48: return 59000000;
      case 49: return 60000000;
      case 50: return 70000000;

     /* add new levels here */
      case LVL_IMMORT: return 80000000;
