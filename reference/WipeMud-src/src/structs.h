...
/* <DoC>
 * Max Number of items a character can quit with.
 */
#define MAX_RENT 28
...
#define CLASS_CLASS5      5
#define CLASS_CLASS6      6
#define CLASS_CLASS7      7
#define CLASS_CLASS8      8
#define CLASS_CLASS9      9
