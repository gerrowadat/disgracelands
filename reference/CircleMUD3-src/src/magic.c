		     ...
		     int spellnum, int savetype)
{
  ...
  if ((GET_MOB_VNUM(victim) == 14205) && (GET_LEVEL(ch) < LVL_IMMORT))/*Yoss - medusa*/
  {
    send_to_char("Medusa turns her eyes to you!\r\nYou flee head over heals.\r\n", ch);
    char_from_room(ch);
    char_to_room(ch, real_room(14284));
...
/* <DoC> */
  case SPELL_HOLY_SMITE:
        ...
        to_vict = "You feel the power of righteous smiting come upon you.";
        break;
/* </DoC> */
...
/* <DoC> */
  case SPELL_HOLY_SHIELD:
    af[0].duration = 4;
    af[0].bitvector = AFF_HOLY_SHIELD;
    accum_duration = TRUE;
    to_vict = "You feel yourself protected by righteousness!";
    break;
/* </DoC> */
...
void mag_areas(int level, struct char_data *ch, int spellnum, int savetype)
{
  ...
  for (tch = world[IN_ROOM(ch)].people; tch; tch = next_tch) {
    ...
    if ((GET_MOB_VNUM(tch) == 14205) && (GET_LEVEL(ch) < LVL_IMMORT) && (!AFF_FLAGGED(ch, AFF_BLIND)))/*Yoss - medusa*/
    {
      send_to_char("Medusa turns her eyes to you!\r\nYou flee head over heals.\r\n", ch);
      char_from_room(ch);
      char_to_room(ch, real_room(14284));
		     ...
		     int spellnum, int savetype)
{
  ...
  case SPELL_FULL_HEAL:
        ...
        send_to_char("Oooh. That feels just *lovely*.\r\n", victim);
        break;
  }
