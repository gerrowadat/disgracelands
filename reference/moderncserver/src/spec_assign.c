...
void assign_mobiles(void)
{
  ...
  ASSIGNMOB(2407, teleporter);
  ASSIGNMOB(2402, thief);
  ASSIGNMOB(2401, cold);
  ASSIGNMOB(2403, plink);

  ASSIGNMOB(2102, magic_user);
  ASSIGNMOB(2103, magic_user);
  ASSIGNMOB(2106, magic_user);
  ASSIGNMOB(2115, magic_user);

  ASSIGNMOB(2101, magic_user);
  ASSIGNMOB(2110, magic_user);
  ...
  ASSIGNMOB(3063, talkera);
  ASSIGNMOB(3106, talkerb);
  ASSIGNMOB(3302, talkerc);
  ...
  ASSIGNMOB(8272, thief);
  ASSIGNMOB(8273, thief);
  ASSIGNMOB(8236, thief);
  ASSIGNMOB(8214, cityguard);
  ASSIGNMOB(8215, cityguard);
  ASSIGNMOB(8233, magic_user);
  ASSIGNMOB(8250, magic_user);
  ASSIGNMOB(8212, thief);
  ASSIGNMOB(8222, fido);
  ASSIGNMOB(8223, fido);
  ASSIGNMOB(8267, magic_user);
  ASSIGNMOB(8264, magic_user);
  ASSIGNMOB(8244, magic_user);
  ASSIGNMOB(8210, magic_user);
  ASSIGNMOB(8211, magic_user);
  ASSIGNMOB(8213, magic_user);
  ASSIGNMOB(8237, snake);
  ASSIGNMOB(8228, janitor);
...
*/
  ...
  ASSIGNMOB(12030, dispeller);
  ASSIGNMOB(12031, magic_user);
  ASSIGNMOB(12032, magic_user);
  ASSIGNMOB(12038, magic_user);
  ASSIGNMOB(12039, magic_user);

  /* Athens */
  ASSIGNMOB(14201, magic_user);
  ASSIGNMOB(14202, remmob);
  ASSIGNMOB(14204, magic_user);
  ASSIGNMOB(14205, magic_user);
  ASSIGNMOB(14206, cityguard);
  ASSIGNMOB(14207, magic_user);
  ASSIGNMOB(14208, cityguard);
  ASSIGNMOB(14211, cityguard);
  ASSIGNMOB(14212, janitor);
  ASSIGNMOB(14214, magic_user);
  ASSIGNMOB(14215, magic_user);
  ASSIGNMOB(14217, magic_user);
  ASSIGNMOB(14220, magic_user);
  ASSIGNMOB(14226, magic_user);
  ASSIGNMOB(14227, cerberus);
  ASSIGNMOB(14229, thief);
  ASSIGNMOB(14232, cityguard);

  ASSIGNMOB(17001, claws);
...
void assign_objects(void)
{
  ASSIGNOBJ(3094, gen_board);   /* suggestion board */
  ASSIGNOBJ(3095, gen_board);   /* pkill board */
  ...
  ASSIGNOBJ(1200, marblesa);
  ASSIGNOBJ(8100, marblesb);
