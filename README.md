...
command in the plan's §10. Two mechanisms are still missing that cut across
every command rather than being any one of them, and they want doing together:
`CAN_SEE` in the *targeting* path — it filters what you can see but not yet
what you can name — and `N.thing` targeting.
