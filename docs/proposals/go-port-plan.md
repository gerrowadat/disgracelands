...
| **5e-ii. Objects carried across a reboot** | `Crash_load`/`Crash_save`: rent, the object save files, and the menu's choice 1 telling a player what they lost. A new persistence format and its own `Store`. | `objsave.c` |
