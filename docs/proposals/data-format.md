...
Every spell's own message, `config/help.yaml`, game config and socials
(the rest of §11 step 6c and §6/§7) are not; see §11 for what landed and
what is still a plan, and why those are staged separately rather than
bundled in.
