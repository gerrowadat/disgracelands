...
// mailSchema is the document's schema tag, docs/proposals/data-format.md
// §10.1.
...
// rather than duplicated — the same choice internal/persist/boards/native
...
// \r that boards/native's own doc comment traces in detail.
...
// bans/native and boards/native have, for the same reason: a mud mail
