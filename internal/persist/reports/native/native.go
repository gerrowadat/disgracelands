...
// memory and rewritten whole, same posture as bans/native: append-only in
...
// mirroring bans/native's Rewrite for the same reason: Append is the only
...
// Append implements reports.Store. native has no fixed-size file to fill,
