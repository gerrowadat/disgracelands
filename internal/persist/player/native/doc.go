...
// Package native implements docs/proposals/data-format.md §8's player
...
// world/native under an alias, since both packages are named native and
...
// docs/proposals/data-format.md §8 shows.
