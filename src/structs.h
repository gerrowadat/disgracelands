 ...
 */
#define _CIRCLEMUD	0x030014 /* Major/Minor/Patchlevel - MMmmPP */
...
/* <DoC> */
#define ROOM_GOOD_REGEN    (1 << 16) /* Good Regeneration. */
#define ROOM_CAN_QUIT		(1 << 17) /* Players Can Quit Here */
#define ROOM_PKILL			(1 << 18) /* PKILL Room */
/* </DoC> */
...
/* <DoC>
 * Macro to see if this user is capable of using magic.
 * Of course, change this if you ever add new classes
 */
#define CAN_USE_MAGIC(cl)     ((((cl) <= 1)||((cl) == 4)) ? 1 : 0)
/*
 * The default class to use for mana consumption
 */
#define DEFAULT_MAGIC_USER_CLASS (CLASS_MAGIC_USER)

/* <DoC>
 * Player Special Flags.
 */
#define PSF_NOWHISPER         (1 << 0)
#define PSF_UNWORTHY  (1 << 1) /* Unworthy Paladin */
#define PSF_FALLEN            (1 << 2) /* Fallen Paladin */
...
#define AFF_HOLY_SHIELD	      (1 << 17)	   /* Room for future expansion	*/
#define AFF_SNEAK             (1 << 18)	   /* Char can move quietly	*/
#define AFF_HIDE              (1 << 19)	   /* Char is hidden		*/
#define AFF_SILENCE	      (1 << 20)	   /* Silenced, cannot cast magic.	*/
...
/*humbug*/
#define ITEM_NO_LOCATE     (1 << 17)    /* Moo Warble PllLooink         */
/*humbug*/
