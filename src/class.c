...
/* <DoC> */
/* Short names for PC class types. */
const char *pc_class_snames[] = {
	"mage",
	"cleric",
	"thief",
	"warrior",
...
/* Remort Vector masks for PC class types 
 * These are Successive powers of 2, and should be included
 * when adding new classes
 */
const int pc_class_remort_masks[] = {
	1,
	2,
	4,
	8,
...
byte saving_throws(int class_num, int type, int level)
{
  ...
  case CLASS_PALADIN:
    ...
    case SAVING_PARA:	/* Paralyzation */
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for paladin paralyzation saving throw.");
	break;	
      }
    case SAVING_ROD:	/* Rods */
      switch (level) {
    ...
    case SAVING_PETRI:	/* Petrification */
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for paladin petrification saving throw.");
	break;
      }
    case SAVING_BREATH:	/* Breath weapons */
      switch (level) {
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for paladin breath saving throw.");
	break;
      }
    case SAVING_SPELL:	/* Generic spells */
      switch (level) {
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for paladin spell saving throw.");
	break;
      }
    default:
      log("SYSERR: Invalid saving throw type.");
...
/* <DoC>
 *
 * Replaced this whole thing, to check only rhe current class
 *
int invalid_class(struct char_data *ch, struct obj_data *obj)
{
...
int invalid_class(struct char_data *ch, struct obj_data *obj)
{
  if (OBJ_FLAGGED(obj, ITEM_ANTI_MAGIC_USER) && (GET_CLASS(ch) == CLASS_MAGIC_USER))
    return TRUE;

  if (OBJ_FLAGGED(obj, ITEM_ANTI_CLERIC) && (GET_CLASS(ch) == CLASS_CLERIC))
    return TRUE;

  if (OBJ_FLAGGED(obj, ITEM_ANTI_WARRIOR) && (GET_CLASS(ch) == CLASS_WARRIOR))
    return TRUE;

  if (OBJ_FLAGGED(obj, ITEM_ANTI_THIEF) && (GET_CLASS(ch) == CLASS_THIEF))
    return TRUE;
...
void init_spell_levels(void)
{
  ...
  spell_level(SPELL_SENSE_LIFE, CLASS_MAGIC_USER, 17);
  ...
  /* PALADINS */
  spell_level(SPELL_DETECT_ALIGN, CLASS_PALADIN, 1);
  spell_level(SKILL_RESCUE, CLASS_PALADIN, 2);
  spell_level(SKILL_KICK, CLASS_PALADIN, 2);
  spell_level(SPELL_BLESS, CLASS_PALADIN, 5);
  spell_level(SPELL_HOLY_SHIELD, CLASS_PALADIN, 5);
  spell_level(SPELL_ARMOR, CLASS_PALADIN, 9);
  spell_level(SPELL_CURE_LIGHT, CLASS_PALADIN, 9);
  spell_level(SKILL_BASH, CLASS_PALADIN, 12);
  spell_level(SPELL_CURE_BLIND, CLASS_PALADIN, 13);
  spell_level(SPELL_REMOVE_POISON, CLASS_PALADIN, 13);
  spell_level(SPELL_CREATE_FOOD, CLASS_PALADIN, 15);
  spell_level(SPELL_CREATE_WATER, CLASS_PALADIN, 15);
  spell_level(SPELL_DISPEL_EVIL, CLASS_PALADIN, 20);
  spell_level(SPELL_SANCTUARY, CLASS_PALADIN, 22);
  spell_level(SPELL_WORD_OF_RECALL, CLASS_PALADIN, 24);
  spell_level(SPELL_HOLY_SMITE, CLASS_PALADIN, 26); 
...
int level_exp(int chclass, int level)
{
  ...
  switch (chclass) {
    ...
    switch (level) {
      ...
      case  9: return 300000;
      case 10: return 600000;
      case 11: return 900000;
      case 12: return 1200000;
      case 13: return 1500000;
      case 14: return 1800000;
      case 15: return 2100000;
      case 16: return 2400000;
      case 17: return 2700000;
      case 18: return 3000000;
      case 19: return 3300000;
      case 20: return 3600000;
      case 21: return 4000000;
      case 22: return 4300000;
      case 23: return 4700000;
      case 24: return 5200000;
      case 25: return 5500000;
      case 26: return 6000000;
      case 27: return 6700000;
      case 28: return 7200000;
      case 29: return 8000000;
      case 30: return 9000000;
      /* add new levels here */
      case LVL_IMMORT: return 9500000;
    }
    break;
  }
...
const char *title_male(int chclass, int level)
{
  ...
  switch (chclass) {
    ...
    case CLASS_PALADIN:
    switch(level) {
      case  1: return "the Firm Believer";
      case  2: return "the Initiate";
      case  3: return "the Tryer";
      case  4: return "the Paladin";
      case  5: return "the Soldier of Good";
      case  6: return "the Honest Fighter";
      case  7: return "the Bearer of Wrath";
      case  8: return "the Bringer of Goodly Smiting";
      case  9: return "the Guardian of the Weak";
      case 10: return "the Enemy of Evil";
      case 11: return "the Humble Hero";
      case 12: return "the Dispenser of Justice";
      case 13: return "the Inquisitor";
      case 14: return "the Expositor";
      case 15: return "the Friend of the Gentle";
      case 16: return "the Greater Paladin";
      case 17: return "the Champion of Good Causes";
      case 18: return "Evilbane";
      case 19: return "the Cavalier";
      case 20: return "the Shining Knight";
      case 21: return "the Righteous Fighter";
      case 22: return "the Smiter of All Evil";
      case 23: return "the Divine Heart";
      case 24: return "the Mighty Paladin";
      case 25: return "the Dispenser-with of Naughty Things";
      case 26: return "the Beating-downer of Evil Thoughts";
      case 27: return "the Guardian of Light";
      case 28: return "the Mighty Redeemer of Sinners";
      case 29: return "the Stern Telling-offer";
      case 30: return "the Firm Rodgerer of Satan's Eye-socket";
      /* no one ever thought up these titles 21-30 */
      case LVL_IMMORT: return "the Immortal Paladin";
      case LVL_GOD: return "the Grand Inquisitor";
      case LVL_GRGOD: return "the God of Justice";
...
const char *title_female(int chclass, int level)
{
  ...
  switch (chclass) {
    ...
    switch(level) {
      ...
      case  9: return "the Guardian of the Weak";
      case 10: return "the Enemy of Evil";
      case 11: return "the Humble Heroine";
      case 12: return "the Dispenser of Justice";
      case 13: return "the Inquisitress";
      case 14: return "the Expositress";
      case 15: return "the Friend of the Gentle";
      case 16: return "the Greater Paladin";
      case 17: return "the Champion of Good Causes";
      case 18: return "Evilbane";
      ...
      case 28: return "the Mighty Redeemer of Sinners";
      case 29: return "the Stern Telling-offer";
      case 30: return "the Snapper-of-Satan's-Neck-With-Her-Thighs";
      /* no one ever thought up these titles 21-30 */
      case LVL_IMMORT: return "the Immortal Paladin";
      case LVL_GOD: return "the Grand Inquisitress";
      case LVL_GRGOD: return "the Goddess of Justice";
      default: return "the Paladin";
    }
    break;
  }
