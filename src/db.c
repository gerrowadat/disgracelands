...
void boot_db(void)
{
  ...
  sort_commands();
  log("Done Sorting Commands. Sorting Spells.");
  sort_spells();
...
void parse_room(FILE *fl, int virtual_nr)
{
  ...
  sprintf(flags, "object #%d", virtual_nr);
